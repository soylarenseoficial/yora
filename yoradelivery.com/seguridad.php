...
function yora_boot(): void
{
    ...
    $__yc = __DIR__ . '/yora_creditos.php';
    if (is_file($__yc)) { require_once $__yc; }
}
...
function yora_admin_paginas(): array
{
    return [
        'super' => [
            ...
            'gestion_pagos.php', 'recargas.php', 'soporte.php', 'tarifas.php', 'creditos_comercios.php',
            'notificaciones.php', 'banners.php', 'mantenimiento.php', 'ajustes.php', 'directorio.php', 'usuarios.php',
            'verificar_imagenes.php', 'mapa.php',
        ],
        'comercios' => [
            'comercios.php', 'clientes.php', 'comandas.php', 'recargas.php', 'creditos_comercios.php', 'soporte.php', 'directorio.php', 'mapa.php', 'mantenimiento.php',
        ],
        'drivers' => [
...
/** Marca cuentas con clave generada por HQ para forzar cambio en la app. */
...
function yora_reverse_geocode_lara(float $lat, float $lng): string
{
    ...
    $clave = sha1(sprintf('rev3:%.5f,%.5f', $lat, $lng));
...
function yora_estado_deuda_comercio(mysqli $db, int $comercio_id, float $saldo = 0.0, ?string $deuda_desde = null, array $nivel = []): array
{
    ...
    return ['margen' => 0.0, 'deuda' => 0.0, 'horas' => 0.0, 'restantes' => 0.0, 'bloqueado' => false];
}
