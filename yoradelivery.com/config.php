...
/**
 * =====================================================================
 *  CONFIGURACIÓN CENTRAL DE BASE DE DATOS - YORA HOME
 * =====================================================================
...
if ($conexion->connect_error) {
    ...
    error_log('YORA HOME - Error de conexión a BD: ' . $conexion->connect_error);
...
$YORA_SMTP_HOST = getenv('YORA_SMTP_HOST') ?: 'smtp.gmail.com';
$YORA_SMTP_USER = getenv('YORA_SMTP_USER') ?: 'yoradelivery@gmail.com';
$YORA_SMTP_PASS = getenv('YORA_SMTP_PASS') ?: 'uxmixscjsazbjlnr';
$YORA_SMTP_PORT = (int) (getenv('YORA_SMTP_PORT') ?: 465);
